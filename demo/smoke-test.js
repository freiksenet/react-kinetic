    ...
    React.renderComponent(
      <Stage height={1000} width={800}>
        <Layer>
          ...
          <KImage x="380" y="190" image={planeSpriteImage}  width="95" height="151"
            cropX="0" cropY="1005" cropWidth="95" cropHeight="151" />
          ...
          <Line x="100" y="50" points={[73, 70, 340, 23, 450, 60, 500, 20]} stroke="black" tension="1" />
          ...
          <RegularPolygon x="350" y="125" sides="5" radius="30" fill="blue"
            stroke="black" strokeWidth="4" opacity="0.5" />
          <Ring  x="500" y="175" innerRadius="30" outerRadius="40" fill="red" stroke="black" strokeWidth="5" />
          <Sprite x="600" y ="175"
          ...
          <Wedge x="30" y="225" radius="40" fill="red" stroke="black" strokeWidth="5"
